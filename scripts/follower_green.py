...
class Follower:
    ...
    def callback(self, data):
        ...
        green_mask = cv.bitwise_xor(green_mask, yellow_mask) #To remove common yellow and green parts
        ...
        cv.imshow('HSV',hsv1)
        #cv.imshow('HSV_green',green_mask)
        #cv.imshow('HSY_rest', mask)
        cv.waitKey(20)
